        ...
        public static bool ErrorHandle(ErrEnum msgEnum, Exception ex)
        {
            ...
            switch (msgEnum)
            {
                case ErrEnum.ErrDllCall:
                    str = Lgu == "zh" ?
                        /*中文*/
                        "初始化CH341 USB-I2C端口错误，请检查相关设备的驱动程序是否已经成功的安装在系统中，如果无法排除此故障，请联系314478060@QQ.COM。" :
                        /*英语*/
                        "Failed to initialize the USB-I2C CH341 equipment, please check the device driver has been successfully installed in the system, if you can not rule out this failure, please contact 314478060@QQ.COM. ";
                    break;
