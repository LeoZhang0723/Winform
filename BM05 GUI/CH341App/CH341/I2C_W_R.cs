...
namespace CH341App
{
    public partial class I2C_W_R : Form
    {
        ...
        public bool IsCall { set { isCall = value; } }   //只写？？
        ...
        private void InitTipMsg()       //private
        {
            // 提示信息
        ...
        private void btnLodWrDat_Click(object sender, EventArgs e)
        {
            ...
            if (!CfgFilLib.ReCfgArr((uint)strArr.Length, ref strArr)) { return; }     //ref 参数传递？？
        ...
        private void btnI2CRead_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rLn == 0)
                {
                    MessageBox.Show("读数据长度为0错误，请检查后重试。");  //弹出消息框
                    return;
                }
        ...
        private void I2C_W_R_Load_1(object sender, EventArgs e)
        {
